            ...
            <StatusBar backgroundColor={Colors.primaryColor1} />
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: wp('100%'), height: hp('8%'), backgroundColor: Colors.primaryColor1 }}>
                    <View style={{ width: wp('60%'), flexDirection: 'row', justifyContent: 'space-between' }}>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginLeft: hp('2%'),}} onPress={() => props.navigation.goBack('BookingSlotTime')}  >
                        ...
                        <Text style={{ fontSize: hp('2.3%'), fontFamily: 'Roboto-Bold', color: Colors.primaryColor3, justifyContent: 'center'}}>Checkout</Text>
                    </View>
                </View>
                {/* </LinearGradient> */}
                ...
                }} onPress={() => props.navigation.navigate('PaymentMethodThird')}>
