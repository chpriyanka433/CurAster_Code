        ...
        <SafeAreaView>
            <View style={styles.container}>
                ...
                <View style={{ width: wp('100%'), height: hp('10%'), flexDirection: 'row', justifyContent: 'space-between', backgroundColor: Colors.primaryColor1 }}>
                    <View style={{ width: wp('45%'), height: hp('10%'), alignItems: 'center', flexDirection: 'row', justifyContent: 'space-around' }}>
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: hp('2%'), color: Colors.primaryColor8 }}>Hi,Olivia</Text>
                        <TouchableOpacity>
                            <FontAwesome5Icon name='angle-down' size={hp('2%')} style={{ color: "#ffffff" }} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: wp('20%'), height: hp('10%'), flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', }}>
                        <TouchableOpacity>
                            <FontAwesome5Icon name='credit-card' size={hp('3%')} style={{ color: "#ffffff" }} />
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <FontAwesome5Icon name='bell' size={hp('3%')} style={{ color: "#ffffff" }} />
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ width: wp('100%'), height: hp('45%'), }}>
                        <View style={{ width: wp('100%'), height: hp('5%'), justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', paddingHorizontal: wp('2.5%'), }}>
                            <Text style={{ fontFamily: 'Roboto-Bold', fontSize: hp('2.5%'), color: Colors.black }}>Find Hospital Near you</Text>
                            <TouchableOpacity>
                                <Text style={{ fontFamily: 'Roboto-Bold', fontSize: hp('1.5%'), color: Colors.primaryColor1 }}>View All</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: wp('48%'), height: hp('12%'), flexDirection: 'row', marginHorizontal: wp('1%'), borderRadius: hp('2%'), marginTop: hp('1%'), }}>
                                <View style={{ width: wp('16%'), height: hp('12%'), alignItems: 'center', }}>
                                    <Image source={require('../Assetst/Images/Fortis.jpg')}
                                        style={{ width: wp('12%'), height: wp('12%'), marginTop: hp('1%') }} resizeMode={'contain'} />
                                </View>
                                <View style={{ width: wp('32%'), height: hp('12%'), padding: wp('1%') }}>
                                    <Text style={{ fontSize: hp('2%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Fortis Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>General Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Noida Sector 62A</Text>
                                    <View style={{ flexDirection: 'row', }}>
                                        <TouchableOpacity >
                                            <FontAwesome5Icon name='star' solid size={hp('1.5%')} style={{ color: Colors.yellow }} />
                                        </TouchableOpacity>
                                        <Text style={{ fontSize: hp('1.5%'), color: Colors.black, }}>4.2(43)</Text>
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={{ width: wp('48%'), height: hp('12%'), flexDirection: 'row', marginHorizontal: wp('1%'), borderRadius: hp('2%'), marginTop: hp('1%'), }}>
                                <View style={{ width: wp('16%'), height: hp('12%'), alignItems: 'center', }}>
                                    <Image source={require('../Assetst/Images/Medanta.png')}
                                        style={{ width: wp('12%'), height: wp('12%'), marginTop: hp('1%') }} resizeMode={'contain'} />
                                </View>
                                <View style={{ width: wp('32%'), height: hp('12%'), padding: wp('1%') }}>
                                    <Text style={{ fontSize: hp('2%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Medanta Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>General Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Noida Sector 62A</Text>
                                    <View style={{ flexDirection: 'row', }}>
                                        <TouchableOpacity >
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: wp('48%'), height: hp('12%'), flexDirection: 'row', marginHorizontal: wp('1%'), borderRadius: hp('2%'), marginTop: hp('1%'), }}>
                                ...
                                <View style={{ width: wp('32%'), height: hp('12%'), padding: wp('1%') }}>
                                    <Text style={{ fontSize: hp('2%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Vedant Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>General Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Noida Sector 62A</Text>
                                    <View style={{ flexDirection: 'row', }}>
                                        <TouchableOpacity >
                            ...
                            <View style={{ width: wp('48%'), height: hp('12%'), flexDirection: 'row', marginHorizontal: wp('1%'), borderRadius: hp('2%'), marginTop: hp('1%'), }}>
                                ...
                                <View style={{ width: wp('32%'), height: hp('12%'), padding: wp('1%') }}>
                                    <Text style={{ fontSize: hp('2%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Cloudine</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>General Hospital</Text>
                                    <Text style={{ fontSize: hp('1.5%'), color: Colors.black, fontFamily: 'Roboto-Bold' }} numberOfLines={1}>Noida Sector 62A</Text>
                                    <View style={{ flexDirection: 'row', }}>
                                        <TouchableOpacity >
