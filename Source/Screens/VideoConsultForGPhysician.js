...
const VideoConsultForGPhysician = (props) => {
        ...
        <SafeAreaView>
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    data={generalDoctor}
                    style={{ width: wp('96%'), maxHeight: hp('20%'), marginLeft: hp('2%') }}
                    renderItem={({ item }) => {
                        return (
                            <TouchableOpacity style={{ width: wp('50%'), height: hp('16%'), borderColor: Colors.primaryColor1, borderWidth: 1, borderRadius: hp('1%'), marginTop: hp('2%'), justifyContent: 'center', marginLeft: hp('1%') }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'center', }}>
                                    <View style={{ width: wp('18%'), justifyContent: 'center', }} >
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: hp('2%'), }}>
                    <View style={{
                        ...
                        <View style={{ width: wp('93.2%'), alignItems: 'center', justifyContent: 'space-between', marginTop: hp('1%'), borderBottomWidth:wp('0.3%'), borderBottomColor:'#d0dae0', }}></View>
                        <View style={{ width: wp('92%'), flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <Text style={{ fontFamily: 'Roboto-Bold', fontSize: hp('2%'), marginRight: hp('1.8%') }}>{'\u20B9'}600</Text>
                        </View>
...
export default VideoConsultForGPhysician;