...
const PaymentStatusThird = (props) => {
                    ...
                    <Modal isVisible={myModal}
                        ...
                        <View style={{ width: wp('92%'), height: hp('17%'), backgroundColor: 'white', borderRadius: hp('1%') }}>
                            ...
                            <View style={{ width: wp('84.2%'), height: hp('6%'), alignItems: "center", justifyContent: "center", marginTop: hp('1%'), alignSelf: "center" }}>
                                <TouchableOpacity onPress={() => props.navigation.navigate('LoadingTwo')} style={{ width: wp('30%'), height: hp('4.8%'), backgroundColor: Colors.primaryColor1, justifyContent: 'center', alignItems: 'center', borderRadius: hp('1%') }}  >
...
export default PaymentStatusThird;
