...
const BookingSlotTimeThird = (props) => {
                ...
                <View style={styles.details}>
                    <View style={styles.doctor}>
                        ...
                        <View style={styles.doc}>
                            ...
                            <View style={{ width: wp('15%'), height: hp('2.3%'), justifyContent: 'center', flexDirection: 'row',alignItems:'center',marginLeft:-wp('1.5%')}}>
...
export default BookingSlotTimeThird;