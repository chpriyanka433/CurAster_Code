...
const DoctorsAppointment2 = (props) => {
    ...
    return (
        <SafeAreaView>
            <View style={styles.Container}>
                ...
                <View style={{ width: wp('100%'), height: hp('7%'), backgroundColor: Colors.primaryColor1 }}>
                    <View style={{ flexDirection: 'row', width: wp('62%'), alignItems: 'center', justifyContent: 'space-between' }}>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginLeft: hp('2%')}} onPress={() => props.navigation.goBack('OnlineConsultation')}  >
                        ...
                        <Text style={{ fontSize: hp('2.3%'), fontFamily: 'Roboto-Bold', color: Colors.primaryColor3, justifyContent: 'center',}}>Select Time</Text>
                    </View>
                </View>
                ...
                <View style={{ width: wp('96%'), height: hp('12%'), justifyContent: 'center', alignItems: 'center', flexDirection: 'row', marginTop: hp('2%') }}>
                    <ScrollView horizontal={true}
                        ...
                        {products.map((val) => {
                            return (
                                <TouchableOpacity key={val.id} onPress={checkClick.bind(this, val.id)} style={{ width: wp('34%'), justifyContent: 'center', alignItems: 'center', height: hp('8%'), backgroundColor: val.id == isCheckSelected ? '#00abf6' : "white", borderRadius: hp('1%'), marginRight: hp('1%'), borderWidth: val.id == isCheckSelected ? 0 : 1.3, borderColor: '#696969' }}>
                ...
                <TouchableOpacity style={{ width: wp('80%'), height: hp('6%'), justifyContent: 'center', alignItems: 'center', backgroundColor: Colors.primaryColor1, borderRadius: hp('1%'), marginTop: hp('3.8%') }} onPress={() => props.navigation.navigate('checkOut')} >
...
export default DoctorsAppointment2;