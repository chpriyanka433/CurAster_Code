                        ...
                        <View style={{ backgroundColor: '#ffffff', height: hp('23%'), width: wp('96%'), alignSelf: "center" }}>
                            ...
                            <View style={{ backgroundColor: '#ffffff', height: hp('20%'), width: wp('88%'), alignSelf: "center", marginTop: hp('2%'), borderRadius: hp('1%'), shadowColor: Colors.primaryColor7, elevation: hp('0.7%') }}>
                                ...
                                <View style={{ flexDirection: "row", height: hp('4%'), width: wp('88%'), paddingLeft: wp('1.5%'), alignItems: "center" }}>
                                    <Text style={{ fontFamily: "Roboto-Medium", fontSize: hp('1.5%'), color: Colors.primaryColor1 }}>Online Consultation</Text>
                                </View>
                                <View style={{ flexDirection: "row", height: hp('9%'), width: wp('88%'), justifyContent: "center", borderBottomColor: Colors.primaryColor5, borderBottomWidth: hp('0.1%'), alignItems: 'center' }}>
                                    ...
                                    <View style={{ height: hp('8%'), width: wp('30%'), justifyContent: 'center', alignItems: 'center' }}>
                                        <TouchableOpacity style={{ flexDirection: 'row', width: wp('24%'), height: hp('4%'), backgroundColor: Colors.primaryColor1, borderRadius: hp('0.8%'), alignItems: 'center', justifyContent: 'center' }} onPress={()=> props.navigation.navigate('VideoCallConnecting')}>
                                            {/* <Text style={{ fontFamily: "Roboto-Bold", fontSize: hp('1.5%'), color: Colors.primaryColor8, textAlign: "center" }}>VIEW DETAILS</Text> */}
                                            <FontAwesome name='video-camera' size={hp('2%')} color={Colors.primaryColor8} />
                                            <Text style={{ fontFamily: "Roboto-Bold", fontSize: hp('1.5%'), color: Colors.primaryColor8, textAlign: "center", marginLeft: hp('0.8%') }}>JOIN CALL</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                        ...
                        <View style={{ backgroundColor: '#ffffff', height: hp('23%'), width: wp('96%'), alignSelf: "center" }}>
                            <View style={{ backgroundColor: '#ffffff', height: hp('20%'), width: wp('88%'), alignSelf: "center", marginTop: hp('2%'), borderRadius: hp('1%'), shadowColor: Colors.primaryColor7, elevation: hp('0.7%') }}>
                                ...
                                <View style={{ flexDirection: "row", height: hp('9%'), width: wp('88%'), justifyContent: "center", borderBottomColor: Colors.primaryColor5, borderBottomWidth: hp('0.1%'), alignItems: 'center' }}>
                                    ...
                                    <View style={{ height: hp('8%'), width: wp('30%'), justifyContent: 'center', alignItems: 'center', }}>
                                        <TouchableOpacity style={{ width: wp('29%'), height: hp('4%'), backgroundColor: Colors.primaryColor1, borderRadius: hp('0.8%'), alignItems: 'center', justifyContent: 'center' }}onPress={()=> props.navigation.navigate('VideoConsultForGP')}>
